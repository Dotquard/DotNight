...
if(!args[0]) return message.channel.send('Bir link ve ad yazmalısın. `?emojiekle https://cdn.discordapp.com/emojis/601379275769118731.png dotnight`');
if(!args[0].endsWith('.png')) return message.channel.send('Doğru bir link yazmalısın.');
if(!args[1]) return message.channel.send('Bir emoji adı yazmalısın. `?emojiekle https://cdn.discordapp.com/emojis/601379275769118731.png dotnight`');
